...
import com.example.ibook.databinding.ActivityProfileEditBinding;
...
public class ProfileEditActivity extends AppCompatActivity {
    ...
    private void uploadImage() {
        ...
        progressDialog.setMessage("Đang tải ảnh người dùng lên");
        progressDialog.show();
        ...
        reference.putFile(imageUri)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(ProfileEditActivity.this, "Đã xảy ra lỗi trong quá trình cập nhật thông tin người dùng...", Toast.LENGTH_SHORT).show();
                    }
                });
    }
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    ...
                    if (result.getResultCode() == Activity.RESULT_OK) {
                        ...
                        Toast.makeText(ProfileEditActivity.this, "Đã Huỷ", Toast.LENGTH_SHORT).show();
                    }
                }
            }
    );
