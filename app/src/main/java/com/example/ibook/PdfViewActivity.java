...
import com.example.ibook.databinding.ActivityPdfViewBinding;
...
public class PdfViewActivity extends AppCompatActivity {
    ...
    public static final String TAG = "PDF_VIEWS_TAG";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //set bookId from intent that we passed in intent
    ...
    private void loadBookDetails() {
        ...
        //bước 1 get book url using book id
        ...
        ref.child(bookId)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        //bước 2: load pdf using that url from firebase storage
                        ...
                        binding.pdfView.fromBytes(bytes)
                                ...
                                .onPageChange(new OnPageChangeListener() {
                                    ...
                                    public void onPageChanged(int page, int pageCount) {
                                        //set curent and total pages in toolbar subtitle
